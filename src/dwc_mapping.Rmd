...
```{r}
input_data <- read_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vRXZwIAQntjB8Z0vBQ0koflTdrMtu1mM2EHZNHkeO5XlHgEdBcSQ5Zwk-bHe_qMedyZ46GEDWFT3NEa/pub?output=csv")
```
