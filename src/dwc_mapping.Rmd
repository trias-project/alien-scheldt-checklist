...
We here use the scientific name provided by the GBIF backbone (`gbif_scientific_name`, to include authorship information). However, in some cases, the scientific name provided by the checklist authors (`scientific_name`) will be kept as the match with the GBIF backbone is `FUZZY` or `HIGHERRANK`

(for now, use a copy of `gbif_scientific_name`)
...
Information for `establishmentMeans` is contained in the field `origin`. These should be conform 
